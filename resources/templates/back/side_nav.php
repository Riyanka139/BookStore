                ...
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="index.php"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
					          ...
					          <li class="">
                        <a href="index.php?orders"><i class="fa fa-check-circle"></i> Orders</a>
                    </li>
                  <li class="">
                    <a href="index.php?reports"><i class="fa fa-file"></i> Reports</a>
                  </li>
                    <li>
                  ...
                  <li>
                    <a href="index.php?slides"><i class="fa fa-sliders"></i> Slides</a>
                  </li>
