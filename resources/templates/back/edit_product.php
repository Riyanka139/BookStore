  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-8">
      ...
      <div class="form-group">
        ...
        <textarea name="product_description" id="" cols="30" rows="7" class="form-control">
    ...
    <aside id="admin_sidebar" class="col-md-4">
      ...
      <div class="form-group">
        ...
        <select name="product_category_id" class="form-control">
          ...
          <?php echo show_category_title($product_category_id); ?>
          </option>
      ...
      <div class="form-group">
        ...
        <br/>
        <img  width="100" height="100" src="../../resources/uploads/<?php echo $product_image; ?>" alt="""/>
